 ...
 */
class ForbiddenDependenciesRule implements Rule
{
    protected const ERROR_MESSAGE = 'Forbidden dependency: A class in namespace `%s` is not allowed to depend on `%s`.';

    protected const IDENTIFIER = 'phauthentic.architecture.forbiddenDependencies';
